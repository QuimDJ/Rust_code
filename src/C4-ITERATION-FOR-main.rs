...
fn main() {
    ...
    // En un for, si usamos el vector directamente se pasa la propiedad al iterator
    // Si usamos el iterador en el for, depende de si es iter() o into_iter()
    // En el primer caso no se traspasa la propiedad y el segundo si.
